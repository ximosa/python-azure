...
# Configuración de voces de Azure
VOCES_DISPONIBLES = {
...
def synthesize_azure(text, voice_name, output_file, subscription_key, region):
    """Genera audio con Azure Text to Speech."""
...
def create_simple_video(texto, nombre_salida, voz, logo_url, font_size, bg_color, text_color,
    ...
    try:
        ...
        for i, segmento in enumerate(segmentos_texto):
            ...
            subscription_key = st.secrets.azure_credentials['subscription_key']
            region = st.secrets.azure_credentials['region']
            success, message = synthesize_azure(segmento, voz, temp_filename, subscription_key, region)
